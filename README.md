...
3. Build your Python + LangGraph + Pinecone project in **your own** repository. Questions must be answered through an **HTTP API only** (no CLI for Q&A). Submit the link and demo video as described in the assignment.
